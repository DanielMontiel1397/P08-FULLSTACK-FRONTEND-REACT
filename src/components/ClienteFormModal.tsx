...
interface ClienteFormModalProps {
    isOpen: boolean;
    onClose: () => void;
    onSubmit: (data: CrearClienteFormType) => void;
    cliente?: ClienteType;
    mode: 'create' | 'edit';
}
...
export default function ClienteFormModal({
    ...
    // 📝 React Hook Form
    const { register, handleSubmit, formState: { errors }, reset } = useForm<CrearClienteFormType>({
    ...
    const handleFormSubmit = (data: CrearClienteFormType) => {
        onSubmit(data);
        onClose();
    };
